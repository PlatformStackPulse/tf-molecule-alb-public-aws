# tf-molecule-alb-public-aws

[![CI](https://github.com/PlatformStackPulse/tf-molecule-alb-public-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-molecule-alb-public-aws/actions/workflows/ci.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)

## Purpose

Terraform molecule: Public ALB with HTTPS listener, HTTP→HTTPS redirect, and target group.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_alb"></a> [alb](#module\_alb) | git::https://github.com/PlatformStackPulse/tf-atom-lb-aws.git | v1.1.0 |
| <a name="module_http_redirect_listener"></a> [http\_redirect\_listener](#module\_http\_redirect\_listener) | git::https://github.com/PlatformStackPulse/tf-atom-lb-listener-aws.git | v1.1.0 |
| <a name="module_https_listener"></a> [https\_listener](#module\_https\_listener) | git::https://github.com/PlatformStackPulse/tf-atom-lb-listener-aws.git | v1.1.0 |
...
| <a name="input_subnet_ids"></a> [subnet\_ids](#input\_subnet\_ids) | Public subnet IDs for the ALB (min 2) | `list(string)` | n/a | yes |
...
| <a name="input_health_check_matcher"></a> [health\_check\_matcher](#input\_health\_check\_matcher) | HTTP codes indicating healthy response | `string` | `"200"` | no |
...
| <a name="input_target_type"></a> [target\_type](#input\_target\_type) | Target type (instance, ip, lambda) | `string` | `"instance"` | no |
